...
export default function Footer() {
  ...
  return (
    <footer className="text-charcoal">
      {/* CTA band */}
      <div className="relative overflow-hidden bg-gradient-to-br from-blue via-blue-dark to-[#083a7a] px-6 py-10 sm:px-10 sm:py-12 lg:px-20 lg:py-14">
        <div
        ...
        <motion.div
          ...
          className="footer-cta-glass relative mx-auto flex max-w-[1320px] flex-col items-start justify-between gap-6 rounded-sm px-7 py-8 sm:flex-row sm:items-center sm:px-10 sm:py-9"
        >
          <div>
      ...
      <div className="border-t-2 border-gold-bright/30 bg-white">
        <div className="container-luxury px-6 py-10 sm:px-10 sm:py-12 lg:px-20 lg:py-14">
          <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-12 lg:gap-10 xl:gap-12">
            <FooterColumn title="Vora Realtors" className="sm:col-span-2 lg:col-span-5" delay={0}>
              <Logo className="h-20 w-auto sm:h-24" />
              <p className="mt-4 max-w-sm text-sm font-medium leading-[1.8] text-charcoal/80">
            ...
            <FooterColumn title="Explore" className="lg:col-span-3" delay={0.08}>
            ...
            <FooterColumn title="Contact" className="lg:col-span-4" delay={0.12}>
          ...
          <motion.div
            ...
            className="mt-10 border-t border-charcoal/10 pt-6 sm:mt-12"
          >
